...
public class Electronics extends Activity {
    GridView gridview;
    public static String[] NameList = {"Logitech Mouse", "Xiaomi Airpods",
            "WB 2TB", "Samsung A12",
    ...
    public static int[] Images = {R.drawable.mouse, R.drawable.airpods, R.drawable.hard,
    ...
    public static int[] PriceList = {171, 350, 1199, 4850, 29640,
